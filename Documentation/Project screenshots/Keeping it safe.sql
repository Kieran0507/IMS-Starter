...
CREATE TABLE IF NOT EXISTS order_line (id INT NOT NULL auto_increment, order_id INT NOT NULL, item_name VARCHAR(40) NOT NULL, quantity INT default 1, PRIMARY KEY (id)); 